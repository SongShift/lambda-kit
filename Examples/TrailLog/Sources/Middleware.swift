...
//  Middleware.swift
//
//  The middleware chain shared by every authenticated route. Same shape as
//  `RoutingDemo`: a passthrough request logger and a stub auth middleware
//  that always succeeds. Production code would verify a JWT (or similar)
